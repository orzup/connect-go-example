...
var file_greet_v1_greet_proto_depIdxs = []int32{
	...
	1, // 4: greet.v1.GreetService.HelloServerStream:output_type -> greet.v1.GreetResponse
	1, // 5: greet.v1.GreetService.HelloClientStream:output_type -> greet.v1.GreetResponse
