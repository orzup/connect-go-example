...
var file_greet_v1_greet_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x48, 0x0a, 0x11, 0x48, 0x65, 0x6c, 0x6c,
	0x6f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x16, 0x2e,
	...
	0x28, 0x01, 0x12, 0x48, 0x0a, 0x0f, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x42, 0x69, 0x64, 0x69, 0x53,
...
var file_greet_v1_greet_proto_depIdxs = []int32{
	...
	0, // 1: greet.v1.GreetService.HelloServerStream:input_type -> greet.v1.GreetRequest
	0, // 2: greet.v1.GreetService.HelloClientStream:input_type -> greet.v1.GreetRequest
	0, // 3: greet.v1.GreetService.HelloBidiStream:input_type -> greet.v1.GreetRequest
	1, // 4: greet.v1.GreetService.Greet:output_type -> greet.v1.GreetResponse
	1, // 5: greet.v1.GreetService.HelloServerStream:output_type -> greet.v1.GreetResponse
	1, // 6: greet.v1.GreetService.HelloClientStream:output_type -> greet.v1.GreetResponse
	1, // 7: greet.v1.GreetService.HelloBidiStream:output_type -> greet.v1.GreetResponse
