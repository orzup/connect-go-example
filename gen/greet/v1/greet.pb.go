...
var file_greet_v1_greet_proto_rawDesc = []byte{
	...
	0x0a, 0x11, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x72,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x1e, 0x5a, 0x1c, 0x65, 0x78, 0x61, 0x6d,
...
var file_greet_v1_greet_proto_depIdxs = []int32{
	...
	0, // 1: greet.v1.GreetService.HelloClientStream:input_type -> greet.v1.GreetRequest
	1, // 2: greet.v1.GreetService.Greet:output_type -> greet.v1.GreetResponse
	1, // 3: greet.v1.GreetService.HelloClientStream:output_type -> greet.v1.GreetResponse
